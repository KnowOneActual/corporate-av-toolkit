...
4. In VLC, press **`E`** to step through the video frame-by-frame:
   * **Perfect Sync**: The 1 kHz audio beep is heard *exactly* when the screen flashes teal and the red bar is aligned with the center **0 ms (SYNC)** line.
...
* [ ] **Power**: Presentation laptop plugged into AC power (do not run on battery!).
